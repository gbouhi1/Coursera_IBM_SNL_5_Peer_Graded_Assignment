...
# Application layout
app.layout = html.Div(children=[ #(start of app frame)
                                ...
                                html.Div([             # (start of selection section)
                                    # Add an division (upper)
                                    html.Div([
                                    ...
                                    ], style={'display':'flex'}), # (end of upper)
                                    
                                   # Add next division (lower)
                                   html.Div([
                                       # Create an division for adding dropdown helper text for choosing year
                                        ...
                                        dcc.Dropdown(id='input-year', 
                                            ...
                                            # Place them next to each other using the division style
                                            ], style={'display': 'flex'}),  # (end of lower)
